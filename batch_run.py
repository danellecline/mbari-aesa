...
matches = []
with open(os.path.join(model_out_dir, 'metrics_all.csv')) as fin:
  fin.write(['Distortion', )
  option_model, model_sub_dir in model_map.iteritems()
...
#np.savetxt(os.path.join(model_out_dir, 'metrics_by_class.csv'), data, header="Accuracy, Precision, F1", fmt='%1.5f', delimiter=",")
