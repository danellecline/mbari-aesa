...
def batch_process(prefix, annotation_file, model_out_dir, exclude_group, options):
  ...
  bottleneck_group_dir = os.path.join(os.getcwd(),'data', 'training_images', prefix,'images_group','bottleneck')

  model_map = { '--image_dir {0} --exclude_unknown --bottleneck_dir {1}'.format(image_category_dir, bottleneck_category_dir): 'category_sans_unk' }
